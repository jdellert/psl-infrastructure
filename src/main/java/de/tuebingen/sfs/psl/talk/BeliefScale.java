...
public class BeliefScale {
    ...
    private static final Belief[] scale = new Belief[]{
            ...
            new Belief(0.05, "very unlikely", "is very unlikely", "very probably not", "very low", "very dissimilar",
                    "not be extremely dissimilar", "(very) dissimilar", "very rarely", "very rare"),
            new Belief(0.15, "unlikely", "is unlikely", "probably not", "low", "dissimilar", "not be very dissimilar",
            ...
            new Belief(0.33, "doubtful", "is doubtful", "doubtfully", "moderately low", "moderately dissimilar",
                    "not be more than moderately dissimilar", "(moderately) dissimilar", "rather rarely",
                    "rather rare"),
            ...
            new Belief(0.66, "fairly plausible", "is fairly plausible", "fairly plausibly", "slightly high",
                    "somewhat similar", "be at least somewhat similar", "only somewhat similar", "somewhat often",
                    "somewhat frequent"),
            new Belief(0.85, "plausible", "is plausible", "plausibly", "moderately high", "moderately similar",
                    "at least moderately similar", "only moderately similar", "rather often", "rather frequent"),
            new Belief(0.95, "likely", "is likely", "probably", "high", "similar", "be more than moderately similar",
                    "slightly less than very similar", "often", "frequent"),
            new Belief(0.99, "very likely", "is very likely", "very probably", "very high", "very similar",
                    "be at least very similar", "slightly less than extremely similar", "very often", "very frequent"),
            ...
            new Belief(100.00, "almost certainly true", "is almost certain", "almost certainly", "extremely high",
                    "extremely similar", "be extremely similar", "extremely similar", "almost always",
                    "extremely frequent")};
    ...
    /**
     * E.g. "[The forms should] be at least somewhat similar." (= somewhat similar and up)
    ...
    /**
     * E.g. "[However, the forms are] only somewhat similar.",
     *      "[However, the forms are] (very) dissimilar.",
     *      "[However, the forms are] slightly less than extremely similar."
     */
    public static String verbalizeBeliefAsMinimumSimilarityOnly(double belief) {
    ...
    private enum VerbalizationType {
        ADJECTIVE, PREDICATE, ADVERB, ADJECTIVE_HIGH, SIMILARITY, SIMILARITY_MIN_INF, SIMILARITY_ONLY, FREQUENCY_ADV,
        FREQUENCY_ADJ
    }
